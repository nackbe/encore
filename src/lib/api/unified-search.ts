...
const KNOWN_LOCATIONS = new Set([
  ...
  'leeds', 'manchester', 'birmingham', 'glasgow', 'edinburgh', 'liverpool', 'bristol',
  'sheffield', 'newcastle', 'nottingham', 'cardiff', 'belfast', 'brighton', 'reading',
  'cologne', 'hamburg', 'munich', 'frankfurt', 'stuttgart', 'düsseldorf', 'dusseldorf',
  'lyon', 'marseille', 'toulouse', 'bordeaux', 'lille', 'nantes',
  'valencia', 'seville', 'bilbao', 'zaragoza', 'malaga',
  'porto', 'florence', 'naples', 'turin', 'bologna',
  'rotterdam', 'antwerp', 'ghent', 'zurich', 'geneva',
  'stockholm', 'gothenburg', 'oslo', 'bergen', 'copenhagen', 'aarhus', 'helsinki',
  'guadalajara', 'monterrey', 'medellin', 'cali',
